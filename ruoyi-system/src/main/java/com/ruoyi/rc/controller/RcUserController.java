package com.ruoyi.rc.controller;
 ...
 */
@Controller
@RequestMapping("/RcUser/userData")
public class RcUserController extends BaseController
{
    private String prefix = "RcUser/userData";

    @Autowired
    private IRcUserService rcUserService;

    @RequiresPermissions("RcUser:userData:view")
    @GetMapping()
     ...
     * 查询用户注册列表
     */
    @RequiresPermissions("RcUser:userData:list")
    @PostMapping("/list")
    @ResponseBody
     ...
     * 导出用户注册列表
     */
    @RequiresPermissions("RcUser:userData:export")
     ...
     * 新增保存用户注册
     */
    @RequiresPermissions("RcUser:userData:add")
     ...
     * 修改保存用户注册
     */
    @RequiresPermissions("RcUser:userData:edit")
     ...
     * 删除用户注册
     */
    @RequiresPermissions("RcUser:userData:remove")
