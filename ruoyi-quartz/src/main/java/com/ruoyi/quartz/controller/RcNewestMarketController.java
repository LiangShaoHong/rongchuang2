...
{
    private String prefix = "system/market";
     ...
     * 查询最新上市列表
     */
    @RequiresPermissions("system:market:list")
    @PostMapping("/list")
    @ResponseBody
     ...
     * 导出最新上市列表
     */
    @RequiresPermissions("system:market:export")
     ...
     * 新增保存最新上市
     */
    @RequiresPermissions("system:market:add")
     ...
     * 修改保存最新上市
     */
    @RequiresPermissions("system:market:edit")
     ...
     * 删除最新上市
     */
    @RequiresPermissions("system:market:remove")
