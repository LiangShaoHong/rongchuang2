 ...
 * @author xiaoxia
 */
@Component("infoYearTask")
public class RcInfoYearTask {
        ...
        for (int i = 1; i < 2; i++) {
            ...
            try {
                ...
                for (Object object : objs) {
                    ...
                    list_all.add(new BasicNameValuePair("type", "y"));
                    Thread.sleep(5000);
                    ...
                    if(!resultInfo.isEmpty()){
                        ...
                        infoData.setInfo_y((String)resultInfo.getString("value"));
                        infoList.add(infoData);
                    }
                }
                infoList.removeIf(Objects::isNull);
                if(infoList.size() != 0){
                    rcTransactionInfoMapper.updateYear(infoList);
                }
            }catch (Exception e) {
