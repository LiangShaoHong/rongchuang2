 ...
 * @author xiaoxia
 */
@Component("infoThreeMonthTask")
public class RcInfoThreeMonthTask {
            ...
            try {
                ...
                for (Object object : objs) {
                    ...
                    if(!resultInfo.isEmpty()){
                        ...
                        infoData.setInfo_3m((String)resultInfo.getString("value"));
                        infoList.add(infoData);
                    }
                }
                infoList.removeIf(Objects::isNull);
                if(infoList.size() != 0){
                    rcTransactionInfoMapper.updateThreeMonth(infoList);
                }
            }catch (Exception e) {
