        ...
        for (int i = 1; i < 2; i++) {
            ...
            try {
                ...
                for (Object object : objs) {
                    ...
                    list_all.add(new BasicNameValuePair("type", "d"));
                    Thread.sleep(5000);
                    ...
                    if(!resultInfo.isEmpty()){
                        ...
                        infoData.setInfo_d((String)resultInfo.getString("value"));
                        infoList.add(infoData);
                    }
                }
                infoList.removeIf(Objects::isNull);
                if(infoList.size() != 0){
                    rcTransactionInfoMapper.updateDay(infoList);
                }
            }catch (Exception e) {
