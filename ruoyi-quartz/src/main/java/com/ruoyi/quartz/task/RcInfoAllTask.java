 ...
 * @author xiaoxia
 */
@Component("infoAllTask")
public class RcInfoAllTask {
        ...
        for (int i = 1; i < 6; i++) {
            ...
            try {
                ...
                for (Object object : objs) {
                    ...
                    list_all.add(new BasicNameValuePair("type", "all"));
                    ...
                    if(!resultInfo.isEmpty()){
                        ...
                        infoData.setInfo_all((String)resultInfo.getString("value"));
                        infoList.add(infoData);
                    }
                }
                infoList.removeIf(Objects::isNull);
                if(infoList.size() != 0){
                    rcTransactionInfoMapper.updateInfoAll(infoList);
                }
            }catch (Exception e) {
