 ...
 * @author xiaoxia
 */
@Component("infoTdtTask")
public class RcInfoYdtTask {
        ...
        for (int i = 1; i < 6; i++) {
            ...
            try {
                ...
                for (Object object : objs) {
                    ...
                    list_all.add(new BasicNameValuePair("type", "ydt"));
                    ...
                    if(!resultInfo.isEmpty()){
                        ...
                        infoData.setInfo_ydt((String)resultInfo.getString("value"));
                        infoList.add(infoData);
                    }
                }
                infoList.removeIf(Objects::isNull);
                if(infoList.size() != 0){
                    rcTransactionInfoMapper.updateYdt(infoList);
                }
            }catch (Exception e) {
