...
/**
 * 币币订单发布对象 rc_currency_order_release
 * 
 * @author ruoyi
 * @date 2020-10-29
 */
public class RcCurrencyOrderRelease extends BaseEntity
{
    ...
    /** 订单类型 1：后台发布 2：系统自动发布 3：指派订单 */
    @Excel(name = "订单类型 1：后台发布 2：系统自动发布 3：指派订单")
