 ...
 */
@Controller
@RequestMapping("/info/rcInformation")
public class RcInformationController extends BaseController
{
    private String prefix = "info/rcInformation";

    @Autowired
    private IRcInformationService rcInformationService;

    @RequiresPermissions("info:rcInformation:view")
    @GetMapping()
     ...
     * 查询系统信息列表
     */
    @RequiresPermissions("info:rcInformation:list")
    @PostMapping("/list")
    @ResponseBody
     ...
     * 导出系统信息列表
     */
    @RequiresPermissions("info:rcInformation:export")
     ...
     * 新增保存系统信息
     */
    @RequiresPermissions("info:rcInformation:add")
     ...
     * 修改保存系统信息
     */
    @RequiresPermissions("info:rcInformation:edit")
     ...
     * 删除系统信息
     */
    @RequiresPermissions("info:rcInformation:remove")
